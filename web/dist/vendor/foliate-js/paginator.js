...
class View {
    ...
    constructor({ container, onExpand }) {
        ...
        // PATCHED (go-bookshelf): upstream also sets `allow-scripts` here as a
        // workaround for WebKit bug https://bugs.webkit.org/show_bug.cgi?id=218086.
        // This app never needs scripts inside the frame and pairing allow-scripts
        // with allow-same-origin would let book content escape the sandbox, so the
        // token is removed. See web/dist/vendor/VERSIONS.md.
